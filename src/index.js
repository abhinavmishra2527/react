...
class App extends React.Component{
    ...
    render(){
        return (
              <div>
                  <form onSubmit={this.calculate} className='ui form'>
                      <div className='field'>
                      <lable>Enter Assignment Marks : </lable>
                      <input type='number' placeholder='Asg Marks' min='0' max='100' onChange={(e)=>{this.setState({ass:e.target.value})}}></input><br/>
                      </div>
                      <div className='field'>
